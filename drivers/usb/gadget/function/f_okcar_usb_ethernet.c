...
struct acc_dev {
	...
	struct usb_interface_descriptor acc_interface_alt_0_desc;
	struct usb_interface_descriptor acc_interface_alt_1_desc;
	struct usb_interface_descriptor acc_interface_alt_2_desc;
	...
	struct usb_descriptor_header *fs_acc_descs[8];
	struct usb_descriptor_header *hs_acc_descs[8];
	struct usb_descriptor_header *ss_acc_descs[8];
			...
			struct usb_function *f, bool configfs)
{
	...
	if (configfs) {
		...
		// 	dev->acc_interface_alt_0_desc.iInterface = ret;
		// 	dev->acc_interface_alt_1_desc.iInterface = ret;
		// 	dev->acc_interface_alt_2_desc.iInterface = ret;
		// }
		dev->cdev = c->cdev;
	}
	...
	if (id < 0)
		return id;
	dev->acc_interface_alt_0_desc.bInterfaceNumber = id;
	dev->acc_interface_alt_1_desc.bInterfaceNumber = id;
	dev->acc_interface_alt_2_desc.bInterfaceNumber = id;
...
static struct usb_function *acc_alloc(struct usb_function_instance *fi)
{
	...
	dev->function.name = "okcar_usb_ethernet";
...
static struct usb_function_instance *acc_alloc_inst(void)
{
	...
	dev->acc_interface_alt_0_desc.bLength					= USB_DT_INTERFACE_SIZE;
	dev->acc_interface_alt_0_desc.bDescriptorType			= USB_DT_INTERFACE;
	dev->acc_interface_alt_0_desc.bInterfaceNumber			= 0;
	dev->acc_interface_alt_0_desc.bAlternateSetting			= 0;
	dev->acc_interface_alt_0_desc.bNumEndpoints				= 0;
	dev->acc_interface_alt_0_desc.bInterfaceClass			= USB_CLASS_VENDOR_SPEC;
	dev->acc_interface_alt_0_desc.bInterfaceSubClass		= 253;
	dev->acc_interface_alt_0_desc.bInterfaceProtocol		= 1;

	dev->acc_interface_alt_1_desc.bLength					= USB_DT_INTERFACE_SIZE;
	dev->acc_interface_alt_1_desc.bDescriptorType			= USB_DT_INTERFACE;
	dev->acc_interface_alt_1_desc.bInterfaceNumber			= 0;
	dev->acc_interface_alt_1_desc.bAlternateSetting			= 1;
	dev->acc_interface_alt_1_desc.bNumEndpoints				= 2;
	dev->acc_interface_alt_1_desc.bInterfaceClass			= USB_CLASS_VENDOR_SPEC;
	dev->acc_interface_alt_1_desc.bInterfaceSubClass		= 253;
	dev->acc_interface_alt_1_desc.bInterfaceProtocol		= 1;

	dev->acc_interface_alt_2_desc.bLength					= USB_DT_INTERFACE_SIZE;
	dev->acc_interface_alt_2_desc.bDescriptorType			= USB_DT_INTERFACE;
	dev->acc_interface_alt_2_desc.bInterfaceNumber			= 0;
	dev->acc_interface_alt_2_desc.bAlternateSetting			= 2;
	dev->acc_interface_alt_2_desc.bNumEndpoints				= 2;
	dev->acc_interface_alt_2_desc.bInterfaceClass			= USB_CLASS_VENDOR_SPEC;
	dev->acc_interface_alt_2_desc.bInterfaceSubClass		= 253;
	dev->acc_interface_alt_2_desc.bInterfaceProtocol		= 1;
	...
	dev->fs_acc_descs[0] = (struct usb_descriptor_header *) &(dev->acc_interface_alt_0_desc);
	dev->fs_acc_descs[1] = (struct usb_descriptor_header *) &(dev->acc_interface_alt_1_desc);
	dev->fs_acc_descs[2] = (struct usb_descriptor_header *) &(dev->acc_fullspeed_in_desc);
	dev->fs_acc_descs[3] = (struct usb_descriptor_header *) &(dev->acc_fullspeed_out_desc);
	dev->fs_acc_descs[4] = (struct usb_descriptor_header *) &(dev->acc_interface_alt_2_desc);
	dev->fs_acc_descs[5] = (struct usb_descriptor_header *) &(dev->acc_fullspeed_in_desc);
	dev->fs_acc_descs[6] = (struct usb_descriptor_header *) &(dev->acc_fullspeed_out_desc);
	dev->fs_acc_descs[7] = NULL;

	dev->hs_acc_descs[0] = (struct usb_descriptor_header *) &(dev->acc_interface_alt_0_desc);
	dev->hs_acc_descs[1] = (struct usb_descriptor_header *) &(dev->acc_interface_alt_1_desc);
	dev->hs_acc_descs[2] = (struct usb_descriptor_header *) &(dev->acc_highspeed_in_desc);
	dev->hs_acc_descs[3] = (struct usb_descriptor_header *) &(dev->acc_highspeed_out_desc);
	dev->hs_acc_descs[4] = (struct usb_descriptor_header *) &(dev->acc_interface_alt_2_desc);
	dev->hs_acc_descs[5] = (struct usb_descriptor_header *) &(dev->acc_highspeed_in_desc);
	dev->hs_acc_descs[6] = (struct usb_descriptor_header *) &(dev->acc_highspeed_out_desc);
	dev->hs_acc_descs[7] = NULL;

	dev->ss_acc_descs[0] = (struct usb_descriptor_header *) &(dev->acc_interface_alt_0_desc);
	dev->ss_acc_descs[1] = (struct usb_descriptor_header *) &(dev->acc_interface_alt_1_desc);
	dev->ss_acc_descs[2] = (struct usb_descriptor_header *) &(dev->acc_superspeed_in_desc);
	dev->ss_acc_descs[3] = (struct usb_descriptor_header *) &(dev->acc_superspeed_out_desc);
	dev->ss_acc_descs[4] = (struct usb_descriptor_header *) &(dev->acc_interface_alt_2_desc);
	dev->ss_acc_descs[5] = (struct usb_descriptor_header *) &(dev->acc_superspeed_in_desc);
	dev->ss_acc_descs[6] = (struct usb_descriptor_header *) &(dev->acc_superspeed_out_desc);
	dev->ss_acc_descs[7] = NULL;

	dev->acc_string_defs[INTERFACE_STRING_INDEX].s  = "";
...
DECLARE_USB_FUNCTION_INIT(okcar_usb_ethernet, acc_alloc_inst, acc_alloc);
MODULE_LICENSE("GPL");
